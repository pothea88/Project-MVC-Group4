    ...
    <header>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav nav-flex-icons">
                        <li class="nav-item">
                            <a href="index.php?action=logout" name="btn-logout" class="nav-link border border-light rounded waves-effect" target="_blank" style="margin-left:850px;">
                                Logout
                            </a>
                        </li>
                    </ul>
        ...
        <div class="sidebar-fixed position-fixed">
            <div class="list-group list-group-flush mt-3">
                <a href="index0.php" class="list-group-item active waves-effect">
                    <i class="fas fa-chart-pie mr-3"></i>Dashboard
                </a>
                <a href="index0.php?action=add_material" class="list-group-item list-group-item-action waves-effect">Add New Material</a>
